...
public class AdapterPopularTvSeriesList extends RecyclerView.Adapter<AdapterPopularTvSeriesList.ViewHolder> {

    private List<TvSeries> mDataTvSeries;
    private OnItemClickedListener mListener;


    public AdapterPopularTvSeriesList(OnItemClickedListener listener) {
        mListener = listener;
    }
